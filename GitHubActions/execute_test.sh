...
################################################################################
#
# This script executes a regression test pf bytea_exif by calling test.sh in
# bytea_exif. If all tests are passed, this script will exit successfully.
...
#     path to install directory of EXIF C library version for testing
#
# Requiremets
# - the source code of PostgreSQL is located in ./workdir/postgresql-{pg_version}.
# - the source code of bytea_exif is loacted in ./workdir/postgresql-{pg_version}/contrib/bytea_exif.
# - PostgreSQL and bytea_exif were built.
