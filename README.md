...
This is a [PostgreSQL](https://www.postgresql.org/) extension which allow to read EXIF data from images stored as `bytea` data in PostgreSQL. This FDW works with all of PostgreSQL 8.4+ and confirmed with libexif 0.6.22.
...
- bool **bytea_has_exif(data bytea)**;
